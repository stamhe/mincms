<?php namespace application\modules\oauth\models; 

 
class OauthConfig extends \application\core\ActiveRecord 
{
	...
	function getIds(){
		...
		$img = \yii\helpers\Html::img($base.'/'.$this->slug.'.png',array());
