...
abstract class Provider
{
	 ...
	 *
	 * Any of the provider options can be set here, such as application_id or secret.
	 *
	...
	/*
	* Get an authorization code from Facebook.  Redirects to Facebook, which this redirects back to the application using the redirect address you've set.
	*/	
	public function authorize($options = array())
	{
		...
		$params = array(
			...
			'response_type' 	=> 'code',
			'applicationroval_prompt'   => 'force' // - google force-recheck
		);
