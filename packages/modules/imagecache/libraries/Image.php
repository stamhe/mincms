<?php namespace application\modules\imagecache\libraries; 
use application\modules\imagecache\libraries\Driver;
...
class Image
{
	...
	public static function forge($config = array(), $filename = null)
	{
		...
		$class = "\application\modules\imagecache\libraries\\".$protocol;
	...
	{
		return static::instance()->save_pa($prepend, $applicationend, $permissions);
	}
