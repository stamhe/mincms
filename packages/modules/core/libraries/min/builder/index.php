...
<p class=topWarning id=jsDidntLoad><strong>Uh Oh.</strong> Minify was unable to
    serve Javascript for this application. To troubleshoot this,
...
<p>When /min/config.php has <code>$min_allowDebugFlag = <strong>true</strong>;</code>
 you can get debug output by applicationending <code>&amp;debug</code> to a Minify URL, or
    ...
    $(function () {
        ...
        $.get(url, function (ocStatus) {
            $.get(url + '&hello=1', function (ocHello) {
                if (ocHello != 'World!') {
                    msg += 'It applicationears output is being automatically compressed, interfering '
