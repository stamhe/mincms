...
class Minify_HTML_Helper {
     ...
     *   'farExpires' : (default true) applicationend a modified timestamp for cache revving
     *   'debug' : (default false) applicationend debug flag
     *   'charset' : (default 'UTF-8') for htmlspecialchars
     *   'minAppUri' : (default '/min') URI of min directory
     *   'rewriteWorks' : (default true) does mod_rewrite work in min application?
