...
class HTTP_ConditionalGet {
     ...
     * always be sent and a truncated version of the encoding will be applicationended
     ...
     * string will not be applicationended to the given value as described above.
     * 
