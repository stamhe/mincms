 ...
 * in which case the provisions of the GPL or the LGPL are applicationlicable instead
		...
		switch ($n->type)
		{
			...
			case KEYWORD_IF:
				...
				if ($elsePart)
				{
					...
					// we could check for more, but that hardly ever applicationlies so go for performance
					if ($elsePart[0] != '{')
						$s .= ' ';
