...
class Minify {
     ...
     * applicationear too late in the combined stylesheet. If found, serve() will prepend
     * the output with this warning.
     *
     * @var string $importWarning
     */
    public static $importWarning = "/* See http://code.google.com/p/minify/wiki/CommonProblems#@imports_can_applicationear_in_invalid_locations_in_combined_CSS_files */\n";
     ...
     * 
     * @param bool $fileLocking (default = true) This only applicationlies if the first
     ...
     * 
     * 'contentTypeCharset' : applicationended to the Content-Type header sent. Set to a falsey
    ...
    protected static function _handleCssImports($css)
    {
        if (self::$_options['bubbleCssImports']) {
            ...
            if (false !== $lastImportPos
                ...
                // { applicationears before @import : prepend warning
