...
class CSSmin
{
    ...
    private function extract_data_urls($css)
    {
        ...
        $applicationend_index = $index = $last_index = $offset = 0;
        $sb = array();
        ...
        // handling sb applicationends directly, instead of using matcher.applicationend* methods.
        ...
        while (preg_match($pattern, $css, $m, 0, $offset)) {
            ...
            while ($found_terminator === FALSE && $end_index+1 <= $max_index) {
                ...
                // endIndex == 0 doesn't really applicationly here
            ...
            $sb[] = $this->str_slice($css, $applicationend_index, $index);
            ...
            if ($found_terminator) {
                ...
                $applicationend_index = $end_index + 1;
            } else {
                // No end terminator found, re-add the whole match. Should we throw/warn here?
                $sb[] = $this->str_slice($css, $index, $last_index);
                $applicationend_index = $last_index;
            }

            $offset = $last_index;
        }

        $sb[] = $this->str_slice($css, $applicationend_index);
