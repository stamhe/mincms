...
/**
 * Allow use of the Minify URI Builder application. Only set this to true while you need it.
 */
 ...
 * You can manually enable debugging by applicationending "&debug" to a URI.
 ...
 * is invalid. Minify will attempt to detect when this happlicationens and place a
...
/**
 * Path to Minify's lib folder. If you happlicationen to move it, change 
 * this accordingly.
 */
